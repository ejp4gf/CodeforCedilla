#Analyze RNA-seq data from MCF10A-5E and MCF10DCIS.com spheroids shCon vs shNRF2v1,v4- for Figure 3B
...
genes=rownames(filt_5E)

y <- DGEList(counts=filt_5E, genes=genes, group=class)
nrow(y)
